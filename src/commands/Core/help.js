...
module.exports = {
    ...
    category: "1.1. 🎖️ | Core",
    description: "Get help on a specific command or get a list of all commands",
    usage: "<command>",
    ...
    run: async (client, msg, args) => {
        ...
        if(!args[0]) {
            ...
            if (!command) return msg.channel.send(`${client.Emojis.x} I couldn't find that command, sorry!`);
